...
class RunCable(object):
    ...
    def create_new_nml_file(
        ...
        replace_dict = {
            ...
            "fixedCO2": "%f" % (co2_conc),
            "ncciy": "%s"
            % (year),  # 0 for not using gswp; 4-digit year input for year of gswp met
...
if __name__ == "__main__":
    ...
    # qsub script is adjusting namelist file, i.e. for a different year
        ...
        C.create_new_nml_file(
            log_fname, out_fname, restart_in_fname, restart_out_fname, year, co2_conc
        )
